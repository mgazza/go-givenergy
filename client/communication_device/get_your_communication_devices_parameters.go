...
// NewGetYourCommunicationDevicesParams creates a new GetYourCommunicationDevicesParams object,
...
func NewGetYourCommunicationDevicesParams() *GetYourCommunicationDevicesParams {
	return &GetYourCommunicationDevicesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetYourCommunicationDevicesParamsWithTimeout creates a new GetYourCommunicationDevicesParams object
...
// NewGetYourCommunicationDevicesParamsWithContext creates a new GetYourCommunicationDevicesParams object
...
// NewGetYourCommunicationDevicesParamsWithHTTPClient creates a new GetYourCommunicationDevicesParams object
...
func (o *GetYourCommunicationDevicesParams) WithDefaults() *GetYourCommunicationDevicesParams {
	o.SetDefaults()
	return o
}
...
func (o *GetYourCommunicationDevicesParams) WithTimeout(timeout time.Duration) *GetYourCommunicationDevicesParams {
...
func (o *GetYourCommunicationDevicesParams) WithContext(ctx context.Context) *GetYourCommunicationDevicesParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get your communication devices params
func (o *GetYourCommunicationDevicesParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get your communication devices params
func (o *GetYourCommunicationDevicesParams) WithHTTPClient(client *http.Client) *GetYourCommunicationDevicesParams {
...
func (o *GetYourCommunicationDevicesParams) WithPage(page *int64) *GetYourCommunicationDevicesParams {
	o.SetPage(page)
	return o
}
...
func (o *GetYourCommunicationDevicesParams) WithPageSize(pageSize *int64) *GetYourCommunicationDevicesParams {
...
func (o *GetYourCommunicationDevicesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
