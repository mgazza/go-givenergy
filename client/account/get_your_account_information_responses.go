...
func (o *GetYourAccountInformationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /account] getYourAccountInformation", response, response.Code())
	}
}
...
func (o *GetYourAccountInformationOK) Error() string {
	...
	return fmt.Sprintf("[GET /account][%d] getYourAccountInformationOK %s", 200, payload)
}
